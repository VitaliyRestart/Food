...
function cards() {
        ...
        class MenuCard {
            constructor(src, alt, title, descr, price, 
                ...
                this.parent = document.querySelector(patentSelector);
                this.transfer = 27;
                this.changeToUAH();
            }
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimerId), 50000);
